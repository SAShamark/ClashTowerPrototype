using UI.Card.Buildings;
using UnityEngine;

public class PlacingBuildInPosition : MonoBehaviour
{
    [SerializeField] private LayerMask _objectSelectionMask;
    [SerializeField] private LayerMask _dropObjectMask;
    [SerializeField] private Camera _camera;
    private BuildingCardPoolController _buildingCardPoolController;
    ...
    private void Start()
    {
        _buildingCardPoolController = BuildingCardPoolController.Instance;
    }
    ...
    {
        _object = null;
        _buildingCardPoolController.AddNewCard();
        CheckDropPlace();
    }
    ...
    private void CheckDropPlace()
    {
        ...
        {
            foreach (var card in _buildingCardPoolController.Cards)
            {
